...
return [
    ...
    'app_produit_delete' => [['id'], ['_controller' => 'App\\Controller\\ProduitController::remove'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/produit']], [], [], []],
    ...
    'App\Controller\ProduitController::create' => [[], ['_controller' => 'App\\Controller\\ProduitController::create'], [], [['text', '/produit/create']], [], [], []],
    'App\Controller\ProduitController::remove' => [['id'], ['_controller' => 'App\\Controller\\ProduitController::remove'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/produit']], [], [], []],
