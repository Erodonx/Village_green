 ...
 */
final class Version20241008143142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE requete CHANGE employe_id requete_employe_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE requete CHANGE requete_employe_id employe_id INT NOT NULL');
